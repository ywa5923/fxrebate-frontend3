                            ...
                            <div className="col-lg-12 m-auto">
                                <div className="single-blog-contents">
                                    ...
                                    <ul className="blog-tags">
                                        <li className="p-1"><Link href="#">Advertising disclosure</Link> </li>
                                        <li className="p-1"><Link href="#">Risk investments</Link> </li>
                                    </ul>
                                    <h2>
                                    Forex Broker Ratings & Reviews
                                    </h2>
                                   
                                    <p>
                                       
                                    Forex Broker Ratings & Reviews  Reliable ratings based on up to 6
                                    importance-weighted categories including
                                    real customer reviews from customers who have synced their live trading account,
                                    as well as regulation strength, broker popularity and web traffic, pricing, features & customer support.
                                    </p>
